...
def score_clip(video_path, visual_score, audio_score, transcript_score, killfeed_templates):
    score = 0
...
def score_all_clips():
    ...
    for clip_path in chunked_videos:
        ...
        final_score = score_clip(clip_path, visual_score, audio_score, transcript_score, killfeed_templates)
